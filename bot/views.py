...
from linebot.models import MessageEvent, TextSendMessage, ImageSendMessage, LocationMessage
import random
    ...
    if request.method == 'POST':
        ...
        for event in events:
            if isinstance(event, MessageEvent):
                ...
                # elif "台北車站" in text:
                    # message = LocationMessage(title='my location', address='Taipei', latitude='25°02'51.2"N',longiture='121°31'02.4"E')
                else:
